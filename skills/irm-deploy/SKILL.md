...
|---|--------|----------|-----------|----------|--------|
| 1 | [소스명] | [PDF/HWP/...] | [extract/vlm] | [전략] | raw/[소스명]/ |
| ... | ... | ... | ... | ... | ... |
...
```json
{
  ...
  "update_trigger": "[갱신 트리거]",
  "update_frequency": "[갱신 주기]"
}
```
...
- Apache AGE 스키마: [Phase 1 search에서 정의한 노드/엣지]
- 시드 데이터 소스: [어떤 문서에서 추출]
- 추출 파이프라인: Cortex 인제스트 시 자동 (extract=true)
